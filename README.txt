...
Prior to version 3.13.3, JOOQ's org.jooq.impl.DefaultRecordMapper.ImmutablePOJOMapperWithParameterNames
will attempt to invoke java.lang.reflect.AccessibleObject.setAccessible(true) on a target POJO's fields
which match the record, potentially throwing an InaccessibleObjectException if the target class is part
of a JPMS module which isn't open to JOOQ.
